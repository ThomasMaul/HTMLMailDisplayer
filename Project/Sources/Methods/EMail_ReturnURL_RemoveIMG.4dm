...
#DECLARE($message_text_t : Text)->$result : Text

// search for embedded images
var $pattern_t:="(?is)(\\<*[img][^\\>]*[src]=\")http(s?)://"
...
Repeat 
	...
	If ($MatchedRgx)
		...
		var $value:=Substring:C12($message_text_t; $Lon_Positions_i+$Lon_Lengths_i-7; 7)  // that should be http 
